...
public class pattern44 {
    ...
    public static void main(String[] args) {
        ...
        for (int row = 1; row <= n; row++) {
            ...
            for (int print = min; print >= 1; print--) {
                int prints = Math.abs(print - row);
                System.out.print((char) (prints+65));
            }
            min += 2;
            System.out.println("");
        }
...
public class pattern45 {
    ...
    public static void main(String[] args) {
        ...
        for (int row = 1; row <= n; row++) {
            ...
            for (int print = row - 1; print >= -(row - 1); print--) {
                System.out.print(row - Math.abs(print));
            }
            System.out.println("");
        }
    }
...
public class pattern46 {
    ...
    public static void main(String[] args) {
        ...
        for (int row = 0; row <= n; row++) {
            ...
            for (int print = row - 0; print >= -(row - 0); print--) {
                int prints = row - Math.abs(print);
                System.out.print((char) (prints + 65));
            }
            System.out.println("");
        }
...
public class pattern54 {
    ...
    public static void main(String[] args) {
        ...
        for (int row = n; row >= -n; row--) {
            for (int col = n; col >= Math.abs(row); col--) {
                System.out.print("*"+" ");
            }
            System.out.println("");
        }
...
public class pattern56 {
    ...
    public static void main(String[] args) {
        int n = 3, min = 6;
        for (int row = n; row >= -n; row--) {
            for (int col = Math.abs(row); col <= n; col++) {
                System.out.print(col+" ");
            }
            System.out.println("");
        }
...
public class pattern59 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int row = n; row >= -n; row--) {
            ...
            for (int print = n; print >= Math.abs(row); print--) {
                System.out.print("*");
            }
            System.out.println("");
        }
...
public class pattern61 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int row = n; row >= -n; row--){
            ...
            for(int print = Math.abs(row); print <= n; print++){
                System.out.print(print);
            }
            System.out.println("");
        }
...
public class pattern69 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int row = n; row >= 1; row--){
            ...
            for(int print = row ; print >= 1; print--){
                System.out.print("* ");
            }
            System.out.println("");
        }
...
public class pattern79 {
    ...
    public static void main(String[] args) throws Exception {
        int n = 5, p = 0, space;
        for (int row = n; row >= -n; row --){
            for (space = 1; space <= Math.abs(row); space ++){
                System.out.print(" ");
            }
            p = row > 0 ? 1 : space;
            for (int print = n; print >= Math.abs(row); print --){
...
public class pattern80 {
    ...
    public static void main(String[] args) throws Exception {
        int n = 5, p = 0,space;
        for (int row = n; row >= -n; row--) {
            for (space = 0; space < Math.abs(row); space++) {
                System.out.print(" ");
            }
            p = row >= 0 ? 0 : space;
            for (int print = n; print >= Math.abs(row); print--) {
