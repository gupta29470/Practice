...
class MedianOfSortedArraysSameSize {
    ...
    public static void main(String[] args) {
        ...
        BigInteger fact = largeFactorial(100, BigInteger.ONE);
        System.out.println(fact);
    }

    public static BigInteger largeFactorial(int n, BigInteger k) {

        if (n == 1) {
            return k;
        }

        return largeFactorial(n - 1, k.multiply(BigInteger.valueOf(n)));
...
3) Put all digits of carry in res[] and increase res_size by number of 
digits in carry.
