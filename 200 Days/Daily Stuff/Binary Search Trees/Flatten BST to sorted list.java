...
2. flattenBSTToSortedList function: passing root
	-> flattenBSTToSortedListUtil function: traverse inorder fashion
	-> if root null then return null
	-> traverse left
	-> if head and previous is null means it is smallest node or left most node
	then update head = root and previous = root : else assign root to 
	previous.right and update previous = previous.right
	-> traverse right
	-> return head
*/
