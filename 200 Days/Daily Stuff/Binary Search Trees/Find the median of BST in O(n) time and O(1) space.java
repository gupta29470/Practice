...
3. in findMedian function create previous object of node type if number of nodes
are even

// odd :
if (count % 2 != 0 && currCount == (count + 1) / 2) then, return current.data

// even 
if (count % 2 == 0 && currCount == (count / 2) + 1)  then,
